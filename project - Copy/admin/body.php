...
<body>
    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <span><input type="text" name="search_trek"><input type="submit" name="serach" value="Search"></span>
...
// execute the query
  ...
  if($result){
      while ($row = mysqli_fetch_assoc($result)) {
          ...
          $sql2="SELECT trek_date,sum(no_of_people) as people FROM trek_details where trek_id='$trek_id'";
